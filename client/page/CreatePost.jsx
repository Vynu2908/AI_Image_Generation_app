...
const handleSubmit = async (e) =>{
  ...
  if(form.prompt && form.photo){
     setLoading(true);
  try{
  const postResponse = await fetch('http://localhost:8080/api/v1/posts', {
    method: POST,
    headers: {
      'Content-Type': 'application/json',
  ...
  return (
    ...
    <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]"> Create imaginative and visually stunning images generated by DALL-E AI and share with community</p>
    </div>
    <form className='mt-16 max-w-3xl' onSubmit={handleSubmit}>
      ...
      />
      <div className='lative bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 w-64 p-3 h-64 flex justify-center items-center'>
        {form.photo ? 
    ...
    <div className='mt-10'>
      <p className='mt-2 text-[#666e75] text-[14px]'>Once you are done with image generation you can share with the community</p>
        <button
            type="submit"
